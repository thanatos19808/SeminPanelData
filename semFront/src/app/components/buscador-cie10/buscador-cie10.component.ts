...
@Component({
  selector: 'app-buscador-cie10',
  templateUrl: './buscador-cie10.component.html',
  styleUrls: ['./buscador-cie10.component.css']
})
export class BuscadorCie10Component implements OnInit {
  queryForm: FormGroup;
  query;
